...
# Check for outliers
outlier_native <- online_natives %>% 
  outlier_chk(., online_L1_grouping_stats, "median_RTmsec")

# Check for normality
normality_native <- online_natives %>% 
...
online_L1_grouping_mat <- 
  online_L1_grouping[! online_L1_grouping %in% c("word_status", 
                                                 "word_initial_syl",
                                                 "target_syl_structure", 
                                                 "group")]
...
online_L1_grouping_lex <- 
  online_L1_grouping[! online_L1_grouping %in% c("target_syl_structure", 
                                                 "word_initial_syl",
                                                 "matching", 
                                                 "group")]
...
#  trans_long(., online_L1_grouping_lex)
