...
my_online_L1_raw_data <- 
  read_csv('analyze_data/output/online_L1_seg_data.csv') %>% 
...
my_L1_data_long <- trans_long(my_L1_data, grouping) 


# Create subgroups for Spanish learners and native speakers
natives <- my_L1_data_long
...
data_mat_ag <- trans_long(my_L1_data, grouping_mat)
...
rm(my_L1_data, my_L1_data_long, learners, natives, words_learners, nonwords_learners,
