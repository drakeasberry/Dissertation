...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/drakeasberry/github/Dissertation_Experiments/segmentation/Segmentation_lastrun.py',
...
for thisPracTarLoop in pracTarLoop:
    ...
    # update component parameters for each repeat
    targetP="practiceListA%i" %pracTarLoop.thisN
