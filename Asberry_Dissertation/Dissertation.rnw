...
\defense{December 09, 2021} % This should have the long date format of your scheduled defense, print it elsewhere with \defensedate
...
%\vspace*{0.3in}
%
%\noindent\underline{\makebox[4.0in][r]{}} \hspace{0.15in} Date: \defensedate \\
%{\bfseries\chairname}\\
%\emph{(Chair)}
%\vspace*{0.3in}
%
...
%\begin{figure}[htb]
%\centering
\includepdf{Figures/Committee_Approval_Page_reduced}
%\decoRule
%\caption[Signed Committee Approval]{Signed approval page}
%\label{fig:Approval-Form}
%\end{figure}
\pagebreak
...
\Sexpr{knit_child('Appendices/Appendix_Intuition.rnw')}
\Sexpr{knit_child('Appendices/Appendix_Segmentation.rnw')}
