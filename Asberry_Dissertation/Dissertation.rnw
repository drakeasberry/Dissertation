...
\usepackage[backend=bibtex, style=authoryear, sorting=nyt, natbib=true]{biblatex} % Use the bibtex backend with the authoryear citation style (which resembles APA) , natbib=true
