...
\Sexpr{knit_child('Chapters/Chapter1.rnw')}
\Sexpr{knit_child('Chapters/Chapter2.rnw')}
\Sexpr{knit_child('Chapters/Chapter3.rnw')}
\Sexpr{knit_child('Chapters/Chapter4.rnw')}
\Sexpr{knit_child('Chapters/Chapter5.rnw')}
\Sexpr{knit_child('Chapters/ChapterTemplate.rnw')}
\Sexpr{knit_child('Chapters/Chapter_Instructions.rnw')}
...
\Sexpr{knit_child('Appendices/AppendixA.rnw')}
%\Sexpr{knit_child('Appendices/AppendixB.rnw')}
%\Sexpr{knit_child('Appendices/AppendixC.rnw')}
