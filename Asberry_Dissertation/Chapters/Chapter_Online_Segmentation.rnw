...
\ttodo{mh: These should really be blocks, not lines in figure me: these are descriptive statistics, but inferential ones. I am not sure what the boxes would add to the existing 95 percent CI error bars already shown.}
\begin{figure}[hbt]
\begin{center}
