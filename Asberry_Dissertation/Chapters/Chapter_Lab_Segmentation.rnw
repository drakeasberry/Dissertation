...
in the first experiment Catalan speakers are monitoring for the syllables controlled vowel i and u I because in Catalan these valves do not reduce. the other two conditions are syllables CV or CVC  structure and stressed or unstressed initials so syllable. the results for Catalan reveal a syllabic segmentation strategy as evidenced by the crossover effect caused by the interaction of syllable structure of the target and syllable structure of the carrier item in the unstressed initial syllable words. when the initial syllable was stressed the interaction was not significant the crossover effect was not obtained. this suggests that Catalan speakers utilize the syllable segmentation strategy in some cases but not all giving us a third option to consider in future studies. evidence here tells us that language users can use it all the time, none of the time, and some of the time with in one monolingual language group , French English Catalan respectively. 
