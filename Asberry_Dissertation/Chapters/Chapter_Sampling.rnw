...
The participants in this group were recruited for because they represented Spanish--English bilingual group. The participants were all born and raised in Mexico and reported learning English as a second language during their school age years in Mexico. %INSERT (age: min, max and mean for learning English) 
At the time of recruitment, all participants were students at the University of Sonora in Sonora, Mexico. 
