...
\ttodo[inline]{mh: looks good. The organization of the first 10 or so pages seems repetitions? Also, you really shouldn't apologize for changing methodologies. Under covid, you changed the methods and questions, but that does NOT make this less than it would have been, just different, right?\newline da: Tried to reorganize a little and reduce repetition, also removed about half the references to COVID19. Second revision removed all COVID19 statements}

In order to better understand the role of the Spanish syllable in segmenting words of Spanish, two distinct groups of speakers were recruited for this dissertation. When the project was originally designed, the hope was to move past the traditional approach of comparing second language learners against monolingual speakers of the target language. Instead, the original intent was to compare bilingual groups against one another where both bilingual populations only shared the same two languages---English and Spanish. The initial design of this project planned to recruit one control group and two separate target groups to investigate the research questions revolving around the processing of Spanish. The control group was to be L1 Spanish speakers who were adult L2 learners of English. The first target group was to be L1 English speakers who were adult L2 learners of Spanish while the second target group was to consist of people who had spoken both English and Spanish since early childhood. However, the project was unable to recruit enough participants that met early childhood Spanish and English acquisition, and were not included in the results of this dissertation. \ttodo[inline]{mh:be careful not to imply that this is less than what you wanted it to be. Rather, you redesigned it based on circumstances and found new opportunities, etc.\newline au: I definitely appreciate that the pandemic forced you to rethink some things but I am not sure that it's necessary to go into this much detail about stuff that did not actually happen. I suggest taking that out and just talking about it from the perspective of what did happen.\newline mh: Again, dont let circumstances drive decision.\newline da: passive voice highlighted resulted to be reexamined, removed COVID19 justification which also fixed the passive voice issue}
The analysis of data in Chapter \ref{ch-seg-lab} revealed small sample sizes across all speaker groups---\Sexpr{lab_analyzed_sum["English", "n"]} L1 English speakers and \Sexpr{lab_analyzed_sum["Spanish", "n"]} L1 Spanish speakers. The data for the remaining two groups were analyzed, but the outcomes related to the syllable and its affect on Spanish processing were null across the board---p > .05 for main effects and interactions. \ttodo[inline]{mh: I'm thinking you need to report this explicitly, with stats and all. Also, I'm thinking you need to test for effect size on those data.\newline da: added a quick synopsis of participant numbers and stats.} Therefore, the experimental design was reevaluated at the same time the transition from in-person to online data collection was being implemented. The original experimental design used a Latin square design, which pooled the results across all of the participants for the various experimental conditions needed to address the research questions and balance the design. However, previous literature was not clear as to whether or not a Latin square design had been implemented. \ttodo[inline]{au: I am a bit wary about this change to the experimental design. More details are needed, and a more exhaustive reading of the relevant literature is necessary so that you can justify the choice of not using a Latin square.\newline da: this is addressed in Chapter \ref{ch-seg-online}} 
Therefore, it was decided against using a Latin square design and submit all experimental conditions to each participant rather than balancing the design across participants during the online data collection phase to allow within-subjects comparisons. \ttodo[inline]{mh: again, not a problem...allows for within-subject comparisons....\newline au: If this resulted in the same item being given more than once to any participant, then you may end up with unintended long-term priming effects. This issue must be addressed in the analysis of the results to ensure that the choice of not using a Latin square didn't render your results ecologically invalid.\newline da: this is addressed in Chapter \ref{ch-seg-online}} 
Lastly, the recruitment of online participants made participant screening a much more difficult task. This also made it hard to obtain the number of required participants needed for statistical power. This resulted in the inclusion of monolingual Spanish speakers to represent the L1 Spanish speaker control group. This chapter serves to describe how these participants were recruited, the characteristics making these groups distinct from one another, inclusion criteria and study conditions for them during their participation---both online and in person. See Table \ref{tab-part-groups-exp}. \ttodo[inline]{mh: I'm thinking a chart of what you wanted and what you have would be good.\newline da: added chart to show what was collected, wanted to be collected and what was not collected au: Again, this is really of limited use, since you can't report on participants that you didn't recruit or whose data/recruitment was dropped. Think in terms of what a journal article would include - you can't publish something about what you did not do.\newline da: modified the chart to include only what was collected after talking with au which served as a happy medium between au and mh feedback.}
...
\toprule
& In-Person & Online\\
Participant & Syllable Intuition & Segmentation\\ 
Group & \& Segmentation & \\
\midrule
L1 Spanish--L2 English & Included & Not Recruited\\
L1 English--L2 Spanish & Included & Included\\
L1 Spanish Monolinguals & Not Recruited & Included\\
%Early Bilinguals & Dropped & Not Recruited\\
\bottomrule
\end{tabular}
\caption{Table lists the types of participants that participated in each of the three experiments in different modalities---In-person or Online.}
\label{tab-part-groups-exp}
\end{table}
...
In an effort to recruit participants for in-person data collection, flyers were distributed on the campuses of the University of Arizona in Tucson, Arizona and the University of Sonora in Hermosillo, Mexico. Emails were also sent to instructors of the Spanish and Portuguese department at the University of Arizona and the faculty of the University of Sonora to forward along to their students, friends and colleagues. All emails and flyers contained a brief description of the study, the type of participants that were needed and contact information for those who were interested in participating. The emails and flyers were written in the primary language of the country where recruitment was taking place. For example, Spanish was used for recruitment materials in Mexico while English was used for all recruitment materials in the US. \ttodo[inline]{au: Please be more specific, since each country has multiple languages.\newline da: explicitly stated what languages were used in which locations} 
All participants in the L1 Spanish speaker control group were recruited in Hermosillo while the participants in the L1 English--L2 Spanish target group were recruited in Tucson. 

Previous studies that investigated speech processing used sample sizes between 20 and 44 participants \parencite{Bradley1993-qq,Chetail2014-nm,Sebastian-Galles1992-xd,Segui1981-uf}. \ttodo[inline]{Please provide specific references to these previous studies.} 
Prior to beginning data collection, a recruitment target of 40 participants for both the control and target groups was set. Setting the recruitment target at the higher end the previous research sample size range was done purposefully. This ensured that even if participants would have to be removed for some reason, a comparable sample size would remain for the analysis of the current study and that of previous literature. In the end, \Sexpr{eligible_grp_desc["Spanish","n"]} L1 Spanish control participants and \Sexpr{eligible_grp_desc["English","n"]} L1 English--L2 Spanish participants were recruited and able to complete the experiments in person before social distancing measures were put into place. 
...
The recruitment for this dissertation turned to an online participant pool managed by Prolific \parencite{noauthor_2020-xx}. Prolific is a participant recruiting site based in the UK that maintains a pool of participants who would like to participate in research studies. Prolific charges the researcher a small fee and requires a fair monetary sum, set by the researcher, be given to research participants in exchange for their involvement in research. The company does not allow identifiable information to be collected on participants---names, emails, phone numbers, etc. The collection of this identifiable information is unnecessary \ttodo[inline]{au: "avoidable" seems like an odd word choice here.\newline da: reworded} 
because every participant is assigned a unique ID string consisting of 24 random numbers and letters when they register for the site and become part of Prolific's participant pool. This ID is used for tracking completion and payment through Prolific. Researchers can also use this ID to ensure participants do not complete multiple submissions to any one experiment during data collection. It can also be used to prevent participants from completing a follow up experiment in the event their participation would not provide valid data or restrict participant access to only those who have previously participated, which is necessary for many longitudinal studies. Prolific requires that participants be screened according to any inclusion criteria before being asked to participate and is done through the filters provided by their site. As a result, the researcher simply sets up the filters that describe their groups of interest and Prolific advertises it to its registered applicant pool based on their self reported answers when they created their Prolific accounts. People who have answered questions that would eliminate their eligibility to certain group demographics or attributes are never presented the opportunity to complete the experiment. This allowed for a large sample of participants to be gathered in a short amount of time with minimal effort given to the screening process from the researcher.

Due to the fact that this second wave of recruitment occurred in response to the unexpected null results from the experiments in Chapter \ref{ch-seg-lab}, a statistical one-tail paired-sample t-test power analysis run prior to beginning online data collection using Jamovi---a program built on top of R \parencite{The_Jamovi_Project2020-lw,R_Core_Team2020-ib}. This decision was made to find the number of necessary participants in a data driven decision rather than loosely following arbitrary numbers used in previous literature. The power analysis was run with the following parameters to determine needed sample size. The minimally interesting effect size was set to \emph{d}=0.4---a medium effect size. \ttodo[inline]{0.4 what? That is, what is the unit of measurement here?\newline da: added in the Cohen's d variable and description for clarification} 
The minimum desired power was set to 0.80 and $\alpha$ equal to 0.05. The results of the statistical power analysis revealed the necessity of 41 participants for both the target and control groups for a total of 82 needed participants. During the online data collection phase, the demographic information of submissions was reviewed periodically to ensure there were no discrepancies that would place a participant outside the intended group for which they were recruited. There were several participants who had discrepancies in fields such as known languages other than Spanish or English, which placed them outside our intended recruitment groups. The data of participants who did not fit the demographics of the recruitment groups were discarded and were replaced by other participants who did meet predefined requirements to ensure the minimum of 41 eligible participants would be available for statistical analysis. This check was repeated until the number of participants needed had been reached at which time the study on Prolific's site was closed.

\section{Participants}
\label{sec-participants}
This dissertation utilized two groups of participants for its design and analysis. The control group always consisted of L1 Spanish speakers while the target groups were always made up of L1 English speakers. The control group participants were L1 Spanish speakers who were L2 learners of English (L1 Spanish--L2 English) for in-person experiments or monolingual Spanish speakers for online experiment.\ttodo[inline]{mh: are the second and third sentences contradicting each other???\newline da: reworded and broke up sentences to make sure they read more clearly} The target group participants consisted of L1 English speakers who were L2 learners of Spanish (L1 English--L2 Spanish). Recruitment and data collection for this group was also done in person and online at separate times due to social distancing. In all cases, participants were chosen based on their language backgrounds according to the results of a survey. Their language proficiency was also considered and was determined by a vocabulary size test. In addition to their language-based characteristics, some general criteria also applied to eligibility requirements. All participants had to be 18 years of age or older. No participant was specifically sought after or excluded from participating based on their assigned or self-identified gender. All other group inclusion criteria was layered over the general specifications and differed between target and control groups. These difference are detailed below.

\subsection{Native Spanish Speakers}
\label{ssec-group-ns}
\ttodo[inline]{mh: You keep repeating the COVID part...\newline da: I removed the COVID part here} 
The first group of L1 Spanish speakers were recruited for in-person experiments. These participants were recruited because they were L2 learners of English and represented L1 Spanish--L2 English bilingual group. These L1 Spanish--L2 English participants were all born and raised in Mexico where Spanish was the only language spoken in the home. They all reported learning English as a second language during their school age years in Mexico and no fluency in any language other than English and Spanish. At the time of recruitment, all participants still resided in Mexico and were enrolled at the University of Sonora in Hermosillo, Mexico. All participation in experimental tasks were completed in person on the University of Sonora campus library. No participants in the L1 Spanish--L2 English group were recruited through Prolific or took part in an online experiment.  

The data collected from the L1 Spanish--L2 English participants was used to represent the control group for syllabic intuitions, Chapter \ref{ch-intuition}, and syllabic segmentation experiments completed in person, Chapter \ref{ch-seg-lab}. For the in-person L1 Spanish group, \Sexpr{eligible_grp_desc["Spanish","n"]} participants meeting all inclusion criteria completed an experiment. The participants ages ranged from \Sexpr{eligible_grp_desc["Spanish","age_Min"]} to \Sexpr{eligible_grp_desc["Spanish","age_Max"]} years old with a mean age of \Sexpr{eligible_grp_desc["Spanish","age_Mean"]} years. The average age that participants reported for the beginning to study English was \Sexpr{eligible_grp_desc["Spanish","eng_acq_age_Mean"]}.
...
& \Sexpr{round(eligible_grp_desc["Spanish","eng_acq_age_Mean"],2)}\\
\bottomrule
\multicolumn{4}{l}{Total participants: n = \Sexpr{eligible_grp_desc["Spanish","n"]}}\\
\end{tabular}
\caption{Attributes of recruited L1 Spanish in-person participants.}
\label{tab-demo-lab-esp}
\end{table}

The second recruitment period for L1 Spanish speakers began after the implementation of social distancing guidelines. Given that this group of participants were being recruited for a second round of experimentation and following up on previous null findings reported in Chapter \ref{ch-seg-lab}, monolingual Spanish speaking participants were the targeted demographic. This decision was made because given previous studies on syllable monitoring the monolingual groups were more consistent in their findings whereas bilingual populations of the those language pairings did not always behave as their monolingual counterparts \parencite{Bradley1993-qq, Cutler1986-zl, Cutler1992-qq, Mehler1981-vi, Sebastian-Galles1992-xd}. Like these previous studies, it was decided that monolingual Spanish speakers should be recruited since monolinguals serve as the baseline behavior because they are unaffected by any subsequent language learning experience. This also allowed us to ensure that experimental items were not the root cause of the null findings in earlier experiment from Chapter \ref{ch-seg-lab}. Lastly, only monolingual Spanish speakers from Mexico were recruited in order to minimize differences between control groups across this project's experiments. In short, all participants that were recruited reported being monolingual Spanish speakers who were born, raised and continued to reside in Mexico. They reported not having any competency or fluency in any other language, including English, even though most school systems required the study of English in order to graduate. \ttodo[inline]{au: fluency, or any degree of competence?\newline da: added explicit verbage to close up potential loopholes}

No monolingual Spanish group participants were recruited for in-person data collection. These participants were recruited to participate in the online experiments and were recruited through Prolific \parencite{noauthor_2020-xx}.\ttodo[inline]{mh: it looks like you're repeating....\newline da: removed repeated information here} Prolific required all screening, filtering based on inclusion criteria, to be done prior to the participants being given the opportunity to complete a research study. Therefore, the responsibility fell to the researcher to correctly set up filters provided by Prolific so that the experiment was advertised to only participants meeting the inclusion criteria of the desired control group demographics. In order to filter the participants recruited for the online monolingual Spanish control group, the four Prolific filters utilized are listed below:
...
& \Sexpr{round(eligible_grp_desc["Monolingual Spanish","age_Mean"],2)} 
& \emph{NA}\\
\bottomrule
...
\label{ssec-group-ls}
Similar to the L1 Spanish speaker control groups, recruitment and data collection for the L1 English speaker target groups also had separate phases. The first group of participants consisted of L1 English speakers who, again, were recruited and participated in person before social distancing restrictions forced online methods to be used. For those that completed in-person experiments, they were all recruited from the University of Arizona campus in Tucson, Arizona. All participants were born and continued to reside in the US. They were all raised as English monolinguals where only English was spoken in the household. They all reported learning Spanish during their school age years while attending school in the United States. In addition, the majority of participants were recruited from Spanish classes where students were currently enrolled in the fifth semester of study or beyond. However, flyers were also distributed around campus,which brought participants that were not currently registered in Spanish classes, but self-reported being able to speak Spanish at an equivalent level.

In total, \Sexpr{eligible_grp_desc["English","n"]} participants made up this in-person experiment subgroup. The participants' ages for those completing in-person experiments ranged from \Sexpr{eligible_grp_desc["English","age_Min"]} to \Sexpr{eligible_grp_desc["English","age_Max"]} with an average of \Sexpr{round(eligible_grp_desc["English","age_Mean"],2)} years of age. The average age that participants reported for the beginning to study Spanish was \Sexpr{round(eligible_grp_desc["English","span_acq_age_Mean"],2)}. The data collected from the first groups of L1 English--L2 Spanish participants was used to represent the target group for syllabic intuitions, Chapter \ref{ch-intuition}, and syllabic segmentation experiments completed in person, Chapter \ref{ch-seg-lab}.
...
& \Sexpr{round(eligible_grp_desc["English","age_Mean"],2)} 
& \Sexpr{round(eligible_grp_desc["English","span_acq_age_Mean"],2)}\\
\bottomrule
...
The participant ages for those completing in-person experiments ranged from \Sexpr{eligible_grp_desc["L2 Learner","age_Min"]} to \Sexpr{eligible_grp_desc["L2 Learner","age_Max"]} years old with an average age of \Sexpr{round(eligible_grp_desc["L2 Learner","age_Mean"],2)} years. The average age that participants reported for the beginning to study Spanish was \Sexpr{round(eligible_grp_desc["L2 Learner","span_acq_age_Mean"],2)}. The data collected from the second L1 English--L2 Spanish target group recruited was used in the analysis conducted for Chapter \ref{ch-seg-online}.\ttodo[inline]{mh: interestingly older that the usual populations we work with.\newline da: this is a very interesting point that may be worth looking into in the future, but unable to complete in this dissertation timeline.}
...
& \Sexpr{round(eligible_grp_desc["L2 Learner","age_Mean"],2)} 
& \Sexpr{round(eligible_grp_desc["L2 Learner","span_acq_age_Mean"],2)}\\
\bottomrule
...
& \Sexpr{round(eligible_gen_desc["Female","age_Mean"],2)} 
& \Sexpr{round(eligible_gen_desc["Female","span_acq_age_Mean"],2)}
& \Sexpr{round(eligible_gen_desc["Female","eng_acq_age_Mean"],2)}\\
Male
& \Sexpr{eligible_gen_desc["Male","n"]}
& \Sexpr{eligible_gen_desc["Male","age_Min"]} 
& \Sexpr{eligible_gen_desc["Male","age_Max"]} 
& \Sexpr{round(eligible_gen_desc["Male","age_Mean"],2)} 
& \Sexpr{round(eligible_gen_desc["Male","span_acq_age_Mean"],2)}
& \Sexpr{round(eligible_gen_desc["Male","eng_acq_age_Mean"],2)}\\
\bottomrule
...
In order to collect the data that has been reported throughout this dissertation, several specialized instruments were utilized. A button box was used to capture reaction times of participant responses (Section \ref{ssec-button-box}).\ttodo[inline]{au: This is not a grammatical sentence.\newline da: reworded} The second was the use of open source software, PsychoPy v3.0.7 and PsychoJS v2020.1.2, to build the experiments, which has been widely used in previous linguistic and behavioral science studies (Section \ref{ssec-psychopy}).\ttodo[inline]{au: Be specific - which software?\newline da: added software names and versions} All software, including packages and libraries, can be found in Appendix \ref{app-software}. In addition to special hardware and software, three task-based instruments were also used to collect additional data about the linguistic experience and proficiency of the participants. The first of these three instruments was a survey that collected information about language experience and use (Section \ref{ssec-blp}). The last two instruments were vocabulary tests used to collect information about vocabulary sizes in English and Spanish (Section \ref{ssec-lextale} and Section \ref{ssec-lextale-esp}). 

\subsection{Button Box}
\label{ssec-button-box}
Many of the measures in this dissertations had a dependent variable based on reaction time. As a result of previous study findings, the difference in reaction times for different experimental conditions were expected to be small. In order to account for these small difference, a button box capable of capturing sub-millisecond measurements was used during all in-person experiments. Once the experiments had been redesigned to run online, the button box was no longer used. During the in-person experiments, the response box was used in all tasks except for the Bilingual Language Profile (BLP) where the internal keyboard and mouse were more efficient for data input and reaction time was not being measured. The response box utilized an arduino Adafruit Feather 32u4 Adalogger micro-controller. This micro-controller was powered through the USB port on the researcher's computer. It was mounted inside of a laser cut acrylic box and wired to five 30mm arcade style buttons mounted in the top face of the box---white, green, blue, yellow and red moving from left to right. The white button was always used to progress to next screen and was offset at 2.25 inches on center from the remaining four colored buttons, which were evenly spaced at 1.75 inches on center. Before deploying the use of the button box, testing was done using a Raspberry Pi 3B+ following guidelines for building a LagBox \parencite{Bockes2018-mn}. The Raspberry Pi testing instrument was tested using other devices as well to ensure the readings being provided were in an acceptable tolerance. For full details on building and testing a button box such as the one used here, please refer to Appendix \ref{app-button-box}.\ttodo[inline]{mh: wants a picture\newline da: pictures are added to appendix}
...
\bottomrule\\
\end{tabular}
\caption{Module score weights used to calculate each language's global score. The weight used in the calculation come directly from the BLP designers.}
...
In total, there were \Sexpr{eligible_desc[1, "n"]} unique participants that were used in the analysis of this dissertation. Of these \Sexpr{eligible_desc[1, "n"]} participants, \Sexpr{eligible_grp_desc["Spanish", "n"] + eligible_grp_desc["Monolingual Spanish", "n"]} were Spanish L1 speakers and \Sexpr{eligible_grp_desc["English", "n"] + eligible_grp_desc["L2 Learner", "n"]} were L1 English speakers. For the Spanish control group, the average Izura score, 
...
In terms of Spanish vocabulary size, the bimodal distribution reflected by the Izura scores reveals the two distinct groups targeted for recruitment were obtained. Figure \ref{plt-hist-eligible-part} shows the distribution of Spanish vocabulary size based on the L1 language of the participants.
...
This is not surprising given that both recruitment groups were L1 Spanish speakers. It would not be expected that learning a second language, English in this case, would cause a decrease in the L1 vocabulary size.
...
@      
\caption[Histogram: Eligible Spanish Participants]{Shows the Spanish vocabulary size for L1 Spanish speaker participants distributed by recruitment method calculated through the equation provided by \parencite{Izura2014-yw}.}
\label{plt-hist-eligible-esp-part}
\end{center}
\end{figure}

For the L1 English speakers, Figure \ref{plt-hist-eligible-ls-part} shows the overlap between the two distribution, which differ from one another in Spanish vocabulary size. The L2 Spanish group recruited online had larger Spanish vocabulary size, 
...
revealed a statistical difference in age between the L1 English groups by recruitment method, 
...
Given the difference in average age,\ttodo[inline]{mh: I wonder if age might have other effects. I suppose this has happened to everybody doing experiments the last year or so, switching to online recruitment and having older subjects.\newline da: still an interesting idea, but unable to complete in this project} it is not surprising that the average length of time from the onset of Spanish acquisition was also higher in the online group, 
...
@      
\caption[Histogram: Eligible English Participants]{Shows the Spanish vocabulary size for L1 English speaker participants distributed by recruitment method calculated through the equation provided by \parencite{Izura2014-yw}.}
...
\ttodo[inline]{au: This sentence feels repetitive given the beginning of the chapter, so I recommend getting rid of it. You don't need to explain this more than once.\newline da: removed the introduction sentences reexplaining COVID.}
