...
Previous studies that investigated speech processing used sample sizes between 20 and 42 participants. \ttodo{Please provide specific references to these previous studies.} 
...
In order to collect the data that has been reported throughout this dissertation, several specialized instruments were utilized. The first of which was a piece of hardware, a button box, that was used to capture reaction times of participant responses (Section \ref{ssec-button-box}). \ttodo{au: This is not a grammatical sentence.} 
The second was the use of open source software to build the experiments, which has been widely used in previous linguistic and behavioral science studies (Section \ref{ssec-psychopy}). \ttodo{au: Be specific - which software?} 
