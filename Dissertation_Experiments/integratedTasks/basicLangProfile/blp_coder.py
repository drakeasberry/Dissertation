...
expInfo = {'Preferred Language:', choices=["espaol", "ingls"]'', 'Participant': '', 'Country': '', 'Age': '', 'Highest level of ed': '', 'Gender': '', 'Place of residence': 'city,state'}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/drakeasberry/github/Dissertation/Dissertation_Experiments/basicLangProfile/blp_coder.py',
