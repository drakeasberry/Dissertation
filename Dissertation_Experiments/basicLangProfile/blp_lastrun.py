...
expInfo = {'participant': '', 'country': '', 'age': '', 'highest level of ed': '', 'gender': '', 'place of residence': 'city,state'}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/drakeasberry/github/psychopy_templates/blp/blp_lastrun.py',
